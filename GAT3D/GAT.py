...
class GATLayer(t.nn.Module):
    ...
    def __init__(
        ...
        self.scoring_fn_target = nn.Parameter(
            t.Tensor(1, num_of_heads, num_out_features)
        )
        ...
        if bias and concat:
            self.bias = nn.Parameter(t.Tensor(num_of_heads * num_out_features))
        elif bias and not concat:
            self.bias = nn.Parameter(t.Tensor(num_out_features))
        else:
